...
- Added new reversed layout 2 on new tab creation page - allows putting smaller widgets on the lefft with large widgets on the right, so side-bar won't over-draw.
