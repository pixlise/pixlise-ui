...
## Data Visualisation for Mars 2020 Rover

![PIXLISE Demo](/readme_assets/pixlise.gif)
...
- For local development, ensure you have a `./client/src/local-development-pixlise-config-PIXLISE.json` file with the appropriate fields set. See `./client/src/local-development-pixlise-config-template.json` for what fields there are. You will need set the values:
  - `auth0_domain`
  - `auth0_client`
...
- Run npm install in the `/client` directory (NOTE: This has a post-install step (`./client/src/version.js`) which generates `./client/src/environments/version.ts`)
...
- [Scott Davidoff](https://github.com/scottdavidoff) - Project Lead
- [Peter Nemere](https://github.com/pnemere) - QUT Lead Developer
- [Ryan Stonebraker](https://github.com/ryanstonebraker) - JPL Senior Full Stack Developer
- [Lyle Klyne](https://github.com/lklyne) - v4.x UX + Visualization Designer
- [Adrian Galvin](https://adriangalvin.space/) - v0 - v3.x UI + Visualization Designer
- [Tom Barber](https://github.com/buggtb) - JPL Infrastructure Developer
- [Michael Fedell](https://github.com/michaelfedell) - JPL Infrastructure Developer
- [Austin Wright](https://github.com/apwright) - Data Science + Machine Learning Lead