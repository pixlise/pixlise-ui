...
//    colors.page_background='#1b1d1e';
//    colors.primary='#ffff8d';
//    config.icon='https://www.pixlise.org/favicon.ico';
    var logo='https://www.pixlise.org/Auth0Logo.png';
//console.log(config);
