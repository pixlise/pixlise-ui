...
import { Location } from "./scan-locations";

export const protobufPackage = "";

export interface ScanLocationReq {
  scanId: string;
...
export interface ScanLocationResp {
  status: ResponseStatus;
  locations: Location[];
}

function createBaseScanLocationReq(): ScanLocationReq {
  return { scanId: "", startingLocation: 0, locationCount: 0 };
}

export const ScanLocationReq = {
  encode(message: ScanLocationReq, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.scanId !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ScanLocationReq {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseScanLocationReq();
  ...
  fromJSON(object: any): ScanLocationReq {
    return {
  ...
  toJSON(message: ScanLocationReq): unknown {
    const obj: any = {};
  ...
  create<I extends Exact<DeepPartial<ScanLocationReq>, I>>(base?: I): ScanLocationReq {
    return ScanLocationReq.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<ScanLocationReq>, I>>(object: I): ScanLocationReq {
    const message = createBaseScanLocationReq();
...
function createBaseScanLocationResp(): ScanLocationResp {
  return { status: 0, locations: [] };
}

export const ScanLocationResp = {
  encode(message: ScanLocationResp, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.status !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ScanLocationResp {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseScanLocationResp();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): ScanLocationResp {
    return {
  ...
  toJSON(message: ScanLocationResp): unknown {
    const obj: any = {};
  ...
  create<I extends Exact<DeepPartial<ScanLocationResp>, I>>(base?: I): ScanLocationResp {
    return ScanLocationResp.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<ScanLocationResp>, I>>(object: I): ScanLocationResp {
    const message = createBaseScanLocationResp();
