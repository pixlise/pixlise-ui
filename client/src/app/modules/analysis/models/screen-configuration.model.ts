...
const ANALYSIS_LAYOUT_2A: FullScreenLayout = {
  tabId: "",
  tabName: "",
  tabDescription: "Layout 2 Reversed",
  hidden: false,
  tags: [],
  rows: [{ height: 2 }, { height: 2 }],
  columns: [{ width: 2 }, { width: 2 }, { width: 2 }, { width: 2 }, { width: 2 }, { width: 2 }],
...
export const ANALYSIS_TEMPLATES: ScreenTemplate[] = [
  ...
  {
    id: "layout-2-a",
    templateName: "Layout 2 Reversed",
    templateIcon: "assets/icons/workspaces-tab.svg",
    layout: ANALYSIS_LAYOUT_2A,
    screenConfiguration: generateTemplateConfiguration(ANALYSIS_LAYOUT_2A),
  },
  {
    id: "layout-3",
