...
export class CtxV2EditPolygon extends CtxV2ToolBase {
  constructor(ctx: ContextImage2Model, host: IContextImageV2ToolHost) {
    super(ContextImageV2ToolId.EDIT_POLYGON, ctx, host, "Pan Tool (Shift)\nClick and drag to move the context image in viewport", "assets/button-icons/tool-line-select.svg");
  }
