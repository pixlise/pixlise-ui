  ...
  contributors: ContributorGroup[][] = [
    ...
    [
      new ContributorGroup("PIXLISE Development Team", [
        ...
        new Contributor("Ryan Stonebraker", "JPL Senior Full Stack Developer"),
        new Contributor("Lyle Klyne", "v4.x UX + Visualization Designer"),
        new Contributor("Tom Barber", "JPL Infrastructure Developer"),
        new Contributor("Michael Fedell", "JPL Infrastructure Developer"),
        new Contributor("Adrian Galvin", "v0 - v3.x Visualization + Design Lead"),
        new Contributor("Jonathan Corkins", "JPL DevOps Engineer"),
