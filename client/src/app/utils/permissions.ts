...
export class Permissions
{
    ...
    {
        if(!claims || !claims[EnvConfigurationInitService.appConfig.auth0_namespace] || !claims[EnvConfigurationInitService.appConfig.auth0_namespace][Permissions.authPermissions])
        {
            // nothing to look in!
            return false;
        }
