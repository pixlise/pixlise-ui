...
TestMap = {} --class
    ...
    function TestMap:testAddMaps()
        ...
        lu.assertEquals(result[1][2], 3.5+11.1)
        lu.assertEquals(result[2][1], 4)
        lu.assertEquals(result[2][2], 5.5+12.1)
        lu.assertEquals(result[3][1], 7)
        lu.assertEquals(result[3][2], 1.3+13.1)
    end
    function TestMap:testAddScalarMap()
        ...
        lu.assertEquals(#result, 3)
        lu.assertEquals(result[1][1], 3)
        lu.assertEquals(result[1][2], 3.5+12)
        lu.assertEquals(result[2][1], 4)
        lu.assertEquals(result[2][2], 5.5+12)
        lu.assertEquals(result[3][1], 7)
        lu.assertEquals(result[3][2], 1.3+12)
    end
    function TestMap:testAddMapScalar()
        ...
        lu.assertEquals(#result, 3)
        lu.assertEquals(result[1][1], 3)
        lu.assertEquals(result[1][2], 3.5+13)
        lu.assertEquals(result[2][1], 4)
        lu.assertEquals(result[2][2], 5.5+13)
        lu.assertEquals(result[3][1], 7)
        lu.assertEquals(result[3][2], 1.3+13)
    end
    --[[
    function TestMap:testAddMaps()
        local l = {[3]=3.5,[4]=5.5,[7]=1.3}
